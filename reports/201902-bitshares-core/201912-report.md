...
This will ensure that release 4.0.0 and all its features, potentially needed hotfixes and API changes can be carried to allow for a smooth release to mainnet.
