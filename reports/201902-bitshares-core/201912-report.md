...
This is an intermediate report for the [2019 BitShares Core Worker proposal](https://www.bitshares.foundation/workers/2019-02-bitshares-core), authored
at the sole discretion of the core worker team.
...
In 2019, the core team will deliver 15 mainnet releases. The most recent release is feature-complete and currently deployed in testnet.
...
In total, the GitHub [bitshares-core](https://github.com/bitshares/bitshares-core) repository alone shows 256 issues and 351 pull requests closed, plus various more in the [`fc`](https://github.com/bitshares/bitshares-fc) and documentation repositories.
...
On 25 OCT 2019, most core team members had their write access removed from the BSIP repository by a single community member. This action halted efforts to continue the work on improvement proposals to polish them for community voting.
...
This corresponds to an uptime of 99.98%, measured from Jan 1 until Nov 13 (today).
...
18 DEC 2019 is the [target date](https://github.com/bitshares/bitshares-core/projects/15) for the next Protocol Release version 4.0.0 activation.
...
during the remaining weeks.
     ...
     In consequence, we, the core worker team, would like to ask all BTS holders to vote the core worker 1.14.163 up again.

This will ensure that release 4.0.0 and all its features and potentially needed hotfixes and API can carried in a timely fashion.
Ryan Fox as the worker manager has agreed to continue with payments in a milestone fashion, where the next agreed upon milestone is release 4.0.0 being polished and released to mainnet.
